...
class VectorsUpdateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => QueriesUpdateManyWithoutVectorsItemsInput,
  })
  @ValidateNested()
  @Type(() => QueriesUpdateManyWithoutVectorsItemsInput)
  @IsOptional()
  @Field(() => QueriesUpdateManyWithoutVectorsItemsInput, {
    nullable: true,
  })
  queriesItems?: QueriesUpdateManyWithoutVectorsItemsInput;
}

export { VectorsUpdateInput as VectorsUpdateInput };
